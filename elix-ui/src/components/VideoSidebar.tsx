...
const VideoSidebar = ({
  ...
  return (
    <div className="fixed right-0 top-0 w-96 h-screen border-l border-pink-900 bg-black flex flex-col z-20">
      <div className="p-4 border-b border-pink-900">
        <h3 className="text-2xl font-bold text-pink-500 mb-2 text-center">VIDEO LIBRARY</h3>
        <Button
        ...
        {isProcessingVideo && (
          <div className="mt-4 p-4 bg-pink-950 border border-pink-800 rounded">
            <div className="flex flex-col items-center space-y-3">
              ...
              <div className="text-center">
                <div className="text-sm text-pink-400 font-bold">PROCESSING</div>
                <div className="text-xs text-pink-300 mt-1">Please wait...</div>
              </div>
            ...
            <div
              ...
              className={`relative group rounded border ${
                isActive 
                  ...
                  : isFailed
                  ? 'border-pink-700 bg-pink-950'
                  : isCompleted
                  ? 'border-green-700 bg-green-950'
                  : 'border-gray-700 bg-gray-800 hover:border-pink-700'
              }`}
            >
                ...
                {isProcessing && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-pink-400">Processing...</div>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  {video.processingStatus && (
                    <p className={`text-xs ${
                      ...
                      video.processingStatus === 'failed' ? 'text-pink-400' :
                      'text-yellow-400'
                    }`}>
              ...
              <Button
                ...
                size="icon"
                className="absolute top-1 right-1 w-6 h-6 bg-pink-600 hover:bg-pink-700 text-white opacity-0 group-hover:opacity-100 transition-opacity"
              >
                <X className="w-3 h-3" />
              </Button>
            </div>
